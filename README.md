...
> [!IMPORTANT] 
> To proceed, set the below environment variables in [`env_setup/vars.env`](tpu-gke-sandbox/blob/main/env_setup/vars.env) to reflect your environment. By default, you will only need to provide your `PROJECT_ID`; replace "YOUR_PROJECT_ID" with the project ID of your Google Cloud project.
